...
- Scoped reports go inside their plan folder; standalone reports go in `plans/reports/`
- One report filename pattern in both locations: `{type}-{YYMMDD-HHmm}-{slug}.md` (see naming-conventions.md "Report File Naming")
